    ...
    >
      <div css={{ marginBottom: "3rem" }}>
        ...
        <h3 className="is-size-5" css={{ color: colors.darkThemeWhite }}>
          Have a Twitter account and want to extend your Edgy free trial another
          14 days? Follow these two steps and we'll make it happen.
        </h3>
      </div>
      <div
        css={{
      ...
      >
        ...
        <p css={{ color: colors.darkThemeWhite }}>
          We love feedback and use it to make Edgy better. A minutes or two of
          your time for a{" "}
          <a
            href="https://www.cloudflare.com/apps/edgy?leaveComment=true"
            target="_blank"
            rel="noopener"
          >
            rating or review
      ...
      <div css={{ display: "flex", alignItems: "center" }}>
        <Step number={2} />
        <p css={{ color: colors.darkThemeWhite }}>
          Tweet something awesome about Edgy and drop us a link to it below.
